...
func TestGetNamespaces(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "existing_namespace_wo_lables_or_annotations",
			namespaces: []runtime.Object{
				&corev1.Namespace{
		...
		{
			name: "existing_namespace_with_single_lable",
			namespaces: []runtime.Object{
				&corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name:   "test_ns_1",
		...
		{
			name: "existing_namespace_with_single_annotation",
			namespaces: []runtime.Object{
				&corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name:        "test_ns_1",
		...
		{
			name: "existing_namespace_with_single_annotation_and_label",
			namespaces: []runtime.Object{
				&corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name:        "test_ns_1",
		...
		{
			name: "existing_namespaces_with_multiple_annotation_and_label",
			namespaces: []runtime.Object{
				&corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name:        "test_ns_1",
...
func TestGetImages(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "existing_namespace_and_pods_no_image",
			pods: []runtime.Object{
				&corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name:        "test_ns_1",
		...
		{
			name: "existing_namespace_and_pods_single_image",
			pods: []runtime.Object{
				&corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name:        "test_ns_1",
		...
		{
			name: "target_less_namespaces_than_images",
			pods: []runtime.Object{
				&corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name:        "test_ns_1",
		...
		{
			name: "target_multiple_images_in_single_namespace",
			pods: []runtime.Object{
				&corev1.Namespace{
					ObjectMeta: metav1.ObjectMeta{
						Name:        "test_ns_1",
